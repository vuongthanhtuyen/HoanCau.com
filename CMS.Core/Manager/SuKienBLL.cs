...
namespace CMS.Core.Manager
{
    public class SuKienBLL
    {
        ...
        public static DanhMuc InsertDanhMuc(DanhMuc danhMuc)
        {
            ...
            if (danhMuc.Type == CategoryType.NhomSuKien && danhMuc.DanhMucChaId != 0)
            {
                return danhMuc;
            }
            ...
            {
                PostId = danhMuc.Id,
                PostType = FriendlyUrlBLL.FriendlyURLTypeHelper.NhomSuKien,
        ...
        public static DanhMuc UpdateDanhMuc(DanhMuc danhMuc)
        {
            ...
            {
                var friendlyUrl = FriendlyUrlBLL.GetByPostIdAndTypeId(danhMuc.Id, FriendlyURLTypeHelper.NhomSuKien);
        ...
        public static bool DeleteDanhMuc(int id)
        {
            ...
            FriendlyUrlBLL.DeleteByPostId(id, FriendlyURLTypeHelper.NhomSuKien);
