...
<asp:Content runat="server" ID="content1" ContentPlaceHolderID="MainContent">
 ...
 <div class="form-group">
    ...
    <h1 runat="server" id="lblcontent">Hello, World!</h1>

    <div>
        <label for="txtEmail">Email</label><br>
        <input type="text" id="txtEmail" name="fEmail" runat="server"><br>
        <label for="txtSubject">Subject</label><br>
        <input type="text" id="txtSubject" name="Subject" runat="server">
        <label for="txtMessage">Message</label><br>
        <input type="text" id="txtMessage" name="Message" runat="server">
        <asp:Button ID="btnSendMail" runat="server" Text="Button" />
    </div>
            ...
            <div class="col-md-12 col-xs-12 text-center">
                <div class="img-thumbnail">
                    <img data-selector="imgThumb" id="imgThumb" runat="server" onclick="OpenSelectImage();" src="/Administration/UploadImage/00000biet-thu-quoc-anh.png"
                        style="cursor: pointer" class="imgthumb img-responsive" />
                </div>
    ...
    <asp:Button ID="btnSend" runat="server" OnClick="btnSend_Click" Text="Gửi dữ liệu + bind" />
