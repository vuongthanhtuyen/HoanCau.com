                      ...
                      <div class=""itemList col-lg-12 col-sm-6 col2"">
                            <div class=""row rowItem row3"">
                                <div class=""col-lg-8 colSlide col3"">
                                    <div class=""wrapImg""><a class=""wrapImgResize img16And9"" href=""{post.Slug}"" title=""{post.TieuDe}"">
                                ...
                                <div class=""col-lg-4 colText align-self-center col3"">
                                    <div class=""contentCol"">
                                        <h2 class=""titleItem""><a class=""linkItem"" href=""{post.Slug}"" title=""{post.TieuDe}"">{post.TieuDe}</a></h2>
                                        <div class=""wrapDes"">{Regex.Replace(post.MoTaNgan, "<.*?>", string.Empty)}</div>
                                        <div class=""wrapBtnItem"">
                                            <a class=""btn1 btnLinkItem"" href=""{post.Slug}"" title=""Chi tiết"">Chi tiết<svg xmlns=""http://www.w3.org/2000/svg"" viewBox=""0 0 448 512"">
