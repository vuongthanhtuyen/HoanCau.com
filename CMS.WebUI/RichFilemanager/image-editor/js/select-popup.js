...
DhTBDScript.Editor = {
    ...
    mainFunction: {
        OnClientLoad: function (sender, arg) {
            DhTBDScript.Editor.Data.editor = sender;
            //console.log(sender, arg);
            DhTBDScript.Editor.Data.editor.get_dialogOpener().add_close(DhTBDScript.Editor.mainFunction.dialogClosed);
            DhTBDScript.Editor.Data.editor.add_commandExecuted(DhTBDScript.Editor.mainFunction.OnClientCommandExecuted);
            DhTBDScript.Editor.Data.editor.get_dialogOpener().get_container().add_pageLoad(function (newsender, newargs) {
                if (newsender.get_navigateUrl().indexOf("DialogName=ImageManager") >= 0) {
                    //console.log('ImageManager load ', sender, newargs);
                    DhTBDScript.Editor.mainFunction.RecruitLoad();
                }
            });
        },
        ...
        OpenImageEditor: function (files) {
            if (files && files.length > 0) {
                var ws = DhTBDScript.Editor.commonFunction.getWindowSize();
                ...
                $.lightbox(url, {
                    ...
                    onClose: function () {
                        ...
                        if (DhTBDScript.Editor.Data.needRefresh === true) {
                            DhTBDScript.Editor.Data.needRefresh = false;
                            DhTBDScript.Editor.Data.ImageManager.refresh();
                        }
                    }
                });
            }
        ...
        OnClientCommandExecuted: function (editor, args) {
            ...
            if (command === "ImageManager") { // You should check for all desired file browser dialogs
                setTimeout(function () {
                    ...
                    DhTBDScript.Editor.Data.errorCount = 0;
                    //RecruitLoad();
                }, 1000);
            }
        },
        RecruitLoad: function () {
            ...
            if (typeof DhTBDScript.Editor.Data.dataWin === 'undefined') {
                var content = DhTBDScript.Editor.Data.editor.get_dialogOpener()._dialogContainers['ImageManager'].get_contentFrame();
                ...
                if (typeof cdoc === 'undefined' || typeof cwin === 'undefined' ||
                    ...
                    setTimeout('DhTBDScript.Editor.mainFunction.RecruitLoad()', 400);
                else {
                    DhTBDScript.Editor.Data.dataWin = cwin;

                    DhTBDScript.Editor.mainFunction.RecruitLoad();
                }
            }
            else {
                //console.log(DhTBDScript.Editor.Data.dataWin);
                try {
                    DhTBDScript.Editor.Data.ImageManager = DhTBDScript.Editor.Data.dataWin.$find('RadFileExplorer1');

                    if (typeof DhTBDScript.Editor.Data.ImageManager === 'undefined'
                        || DhTBDScript.Editor.Data.ImageManager === null)
                        setTimeout('DhTBDScript.Editor.mainFunction.RecruitLoad()', 400);
                    else {

                        var head = DhTBDScript.Editor.Data.dataWin.document.getElementsByTagName('head')[0];
                        if (head !== null) {
                        ...
                        var previewWindow = DhTBDScript.Editor.Data.dataWin.$find("ImagePreviewToolBar");
                        ...
                        previewWindow._events._list.buttonClicked.splice(0, 0, function (sender, args) {
                            ...
                            if (args.get_item()._properties._data.value === 'ImageEditor') {
                                ...
                                var files = DhTBDScript.Editor.Data.ImageManager.get_selectedItems();
                                if (files.length > 0) {
                                    var sss = '';
                                    ...
                                    if (sss.length > joinKey.length)
                                        DhTBDScript.Editor.mainFunction.OpenImageEditor(sss);
                                }
                        ...
                        DhTBDScript.Editor.Data.ImageManager._events._list.itemSelected.push(DhTBDScript.Editor.mainFunction.OnClientItemSelected);


                        var toolbar = DhTBDScript.Editor.Data.ImageManager.get_toolbar();
                        //var toolbar = DhTBDScript.Editor.Data.dataWin.$find('RadFileExplorer1_toolbar');
                        ...
                        toolbar._events._list.buttonClicked.splice(0, 0, function (sender, args) {
                            ...
                            if (args.get_item()._properties._data.value === 'Upload') {
                                //console.log(sender, args);
                                if (DhTBDScript.Editor.Data.dataWin.$telerik.$('#RadFileExplorer1_chkOpenEditor').length === 0) {
                                    var uploadContainer = DhTBDScript.Editor.Data.dataWin.$telerik.$('#RadFileExplorer1_uploadContainer').get(0);

                                    var label = DhTBDScript.Editor.Data.dataWin.$telerik.$("label[for='RadFileExplorer1_chkOverwrite']", uploadContainer);
                                    ...
                                    setTimeout(function () {
                                        var uploadwindow = DhTBDScript.Editor.Data.dataWin.$find('RadFileExplorer1_windowManagerfileExplorerUpload');
                                        if (typeof uploadwindow !== 'undefined') {
                                            uploadwindow._events._list.close.push(function () {
                                                //console.log(DhTBDScript.Editor.Data.dataWin.$telerik.$('#RadFileExplorer1_chkOpenEditor').is(':checked'));
                                            });
                                        }
                                    }, 500);
                                }
                    ...
                    DhTBDScript.Editor.Data.errorCount += 1;
                    if (DhTBDScript.Editor.Data.errorCount === 5) { }
                    else
                        DhTBDScript.Editor.mainFunction.RecruitLoad();
                }
            }
...
$(function () {
    $(window).resize(function () {
        DhTBDScript.Editor.commonFunction.delay(function () {
            var obj = $.lightbox();
...
function LoadFileUploaded(files) {
    ...
    DhTBDScript.Editor.mainFunction.OpenImageEditor(files);
}
