...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {  "avi", "bmp", "csv", "doc", "docx", "fla", "flv", "gif", "jpeg", "jpg", "mid", "mov", "mp3", "mp4", "pdf", "png", "ppt", "pptx", "pxd", "rar", "txt", "xls", "xlsx", "zip", "svg" };
        type.DeniedExtensions = new string[] { "exe", "dll","php", "aspx", "ascx" };
