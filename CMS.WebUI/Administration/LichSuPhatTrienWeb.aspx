<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" MasterPageFile="~/Administration/MasterPage/AdminPage.Master" CodeBehind="LichSuPhatTrienWeb.aspx.cs" Inherits="CMS.WebUI.Administration.LichSuPhatTrienWeb" %>
    ...
    <main>
        ...
        <asp:GridView ID="GridViewTable" runat="server" AutoGenerateColumns="false"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Hình hiển thị">
                    <ItemTemplate>
                        <img src='<%# Eval("HinhAnhUrl", "/Administration/UploadImage/{0}") %>'
                            alt="Company Logo" style="width: auto; height: 100px; object-fit: cover;" />
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <div class="col-md-11">
                    <div class="form-group row">
                        <div class="col-md-8">
                            ...
                            <asp:TextBox ID="txtTieuDe" runat="server" CssClass="form-control form-control-user" placeholder="Tiêu đề "></asp:TextBox>
                        </div>
                        <div class="col-md-4">
                            <label for="txtNam">Năm</label>
                            <asp:TextBox ID="txtNam" runat="server" placeholder="Năm" CssClass="form-control form-control-user"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="txtMoTa">Mô tả</label>
                        <uc1:SummernoteEditor runat="server" ID="txtMoTa" />
                    </div>
            ...
            <div class="row justify-content-center main-edit-modal">
                ...
                <div class="col-md-11">
                    <div class="col-md-11">
                        <div class="form-group row">
                            <div class="col-md-8">
                                <label for="txtEditTieuDe">Tiêu đề</label>
                                <asp:TextBox ID="txtEditTieuDe" runat="server" CssClass="form-control form-control-user" placeholder="Tiêu đề"></asp:TextBox>
                            </div>
                            <div class="col-md-4">
                                <label for="txtEditNam">Năm</label>
                                <asp:TextBox ID="txtEditNam" runat="server" placeholder="Năm" CssClass="form-control form-control-user"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="txtEditMoTa">Mô tả</label>
                            <uc1:SummernoteEditor runat="server" ID="txtEditMoTa" />
                        </div>
                        ...
                        <div>
                            <div class="form-group">
                                <label for="txtEditThumbnailUrl">Ảnh Thumbnail</label>
