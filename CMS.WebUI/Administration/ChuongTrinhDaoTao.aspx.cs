...
{
    public partial class ChuongTrinhDaoTao : AdminPermistion
    {
        public override string MenuMa { get; set; } = "Quan-ly-chuong-trinh-dao-tao";
        ...
        private void BindDataTree()
        {
            try
            {
                ...
                List<DanhMuc> lst = DanhMucBaiVietBLL.GetAllNoPaging(ApplicationContext.Current.ContentCurrentLanguageId, CategoryType.ChuongTrinhDaoTao, Request.QueryString["search"]);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                danhMuc.Type = CategoryType.ChuongTrinhDaoTao;
                ...
                if (isAdd)
                {
                    ...
                    danhMuc = ChuongTrinhDaoTaoBLL.InsertDanhMuc(danhMuc);
                    //ShowNotification("Lưu thành công", false);
                    OpenMessageBox(MessageBoxType.Success, MessageBoxString.Success);
                    LichSuHeThongBLL.LogAction(LichSuHeThongType.INSERT, LichSuHeThongGroup.QuanLyChuongTrinhDaoTao, danhMuc.Ten);
                }
                else
                {
                    danhMuc = ChuongTrinhDaoTaoBLL.UpdateDanhMuc(danhMuc);
                    LichSuHeThongBLL.LogAction(LichSuHeThongType.UPDATE, LichSuHeThongGroup.QuanLyChuongTrinhDaoTao, danhMuc.Ten);
                    ...
                    //        {
                    //            var updateObj = ChuongTrinhDaoTaoBLL.GetAttachmentFilebyPostIdAndTypeAndId(danhMuc.Id, ChuongTrinhDaoTaoType.FileDinhKem, id);
                    //            if (updateObj != null)
                    //            {
                    //                updateObj.Title = newAtt.Title;
                    //                updateObj.FileUrl = newAtt.FileUrl;
                    //                updateObj = ChuongTrinhDaoTaoBLL.UpdateAttachmentFileInPost(updateObj);
                    ...
                    //        else
                    //        {
                    //            //ChuongTrinhDaoTao attachmentFile = new ChuongTrinhDaoTao()
                    //            //{
                    //            //    CategoryId = danhMuc.Id,
                    //            //    Type = ChuongTrinhDaoTaoType.FileDinhKem,
                    //            //    FileUrl = newAtt.FileUrl,
                    //            //    Title = newAtt.Title,
                    //            //};
                    //            //ChuongTrinhDaoTaoBLL.InsertAttachmentFileInPost(attachmentFile);
                    //        }
                    ...
                    //        ChuongTrinhDaoTaoBLL.DeleteAttachmentFile(att.Id);
                    //    }
                    //}
                    //else
                    //{
                    ...
                    //    {
                    //        ChuongTrinhDaoTaoBLL.DeleteAllAttachmentFileInPost(danhMuc.Id, ChuongTrinhDaoTaoType.FileDinhKem);
                    //    }
                    //}
                    #endregion
                }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(id.ToString()) && id > 0)
                {
                    ...
                    ChuongTrinhDaoTaoBLL.DeleteDanhMuc(id);
                    LichSuHeThongBLL.LogAction(LichSuHeThongType.DELETE, LichSuHeThongGroup.QuanLyChuongTrinhDaoTao, danhMuc.Ten);
