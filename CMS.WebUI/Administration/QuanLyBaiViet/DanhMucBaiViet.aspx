                                    ...
                                    <div class="card card-primary card-outline card-outline-tabs">
                                        <div class="card-header p-0 border-bottom-0">
                                            <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="default-setting-category-tab" data-toggle="pill" href="#default-setting-category" role="tab" aria-controls="default-setting-category" aria-selected="true">Home</a>
                                                </li>
                                                <li class="nav-item" visible="false" runat="server" id="tabBaiViet">
                                                    <a class="nav-link" id="article-in-category-tab" data-toggle="pill" href="#article-in-category" role="tab" aria-controls="article-in-category" aria-selected="false">Profile</a>
                                                </li>
