<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administration/MasterPage/AdminPage.Master" CodeBehind="ThanhVien.aspx.cs" Inherits="CMS.WebUI.Administration.ThanhVien" %>
                ...
                <ContentTemplate>
                    <asp:GridView ID="GridViewTable" runat="server" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="TieuDe" HeaderText="Tên" />
                            <asp:TemplateField HeaderText="Nhóm">
                                <ItemTemplate>
                                    <%# Eval("TenDanhMuc") ?? "Không"  %>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <div class="row justify-content-center main-edit-modal">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        <label for="txtViewCount">Nhóm cơ cấu</label>
                                        <asp:DropDownList ID="ddlParent" runat="server" CssClass="form-control form-control-user">
                                        </asp:DropDownList>
                                    </div>
                                    <div class="form-group">
