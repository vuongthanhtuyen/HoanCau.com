...
namespace SweetCMS.DataAccess
{
	...
	public partial class LoaiQuyen : ActiveRecord<LoaiQuyen>, IActiveRecord
	{
		...
		public SweetCMS.DataAccess.VaiTroDanhMucLoaiQuyenChiTietCollection VaiTroDanhMucLoaiQuyenChiTietRecords()
		{
			...
			{
				colVaiTroDanhMucLoaiQuyenChiTietRecords = new SweetCMS.DataAccess.VaiTroDanhMucLoaiQuyenChiTietCollection().Where(VaiTroDanhMucLoaiQuyenChiTiet.Columns.LoaiQuyenId, Id).Load();
