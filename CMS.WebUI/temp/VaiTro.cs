...
namespace SweetCMS.DataAccess
{
	...
	public partial class VaiTro : ActiveRecord<VaiTro>, IActiveRecord
	{
		...
		public SweetCMS.DataAccess.NguoiDungVaiTroChitietCollection NguoiDungVaiTroChitietRecords()
		{
			...
			{
				colNguoiDungVaiTroChitietRecords = new SweetCMS.DataAccess.NguoiDungVaiTroChitietCollection().Where(NguoiDungVaiTroChitiet.Columns.VaiTroId, Id).Load();
		...
		public SweetCMS.DataAccess.VaiTroDanhMucLoaiQuyenChiTietCollection VaiTroDanhMucLoaiQuyenChiTietRecords()
		{
			...
			{
				colVaiTroDanhMucLoaiQuyenChiTietRecords = new SweetCMS.DataAccess.VaiTroDanhMucLoaiQuyenChiTietCollection().Where(VaiTroDanhMucLoaiQuyenChiTiet.Columns.VaiTroId, Id).Load();
