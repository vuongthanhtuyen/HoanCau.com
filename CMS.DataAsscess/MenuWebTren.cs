...
{
	/// <summary>
	/// Strongly-typed collection for the MenuWebTren class.
	/// </summary>
    [Serializable]
	public partial class MenuWebTrenCollection : ActiveList<MenuWebTren, MenuWebTrenCollection>
	{	   
		public MenuWebTrenCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>MenuWebTrenCollection</returns>
		public MenuWebTrenCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                MenuWebTren o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the MenuWebTren table.
	/// </summary>
	[Serializable]
	public partial class MenuWebTren : ActiveRecord<MenuWebTren>, IActiveRecord
	{
		...
		public MenuWebTren(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public MenuWebTren(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public MenuWebTren(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("MenuWebTren", TableType.Table, DataService.GetInstance("DataAcessProvider"));
				...
				DataService.Providers["DataAcessProvider"].AddSchema("MenuWebTren",schema);
			}
		}
		#endregion
