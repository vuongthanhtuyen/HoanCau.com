...
namespace TBDCMS.DataAccess
{
	...
	public partial class NguoiDung : ActiveRecord<NguoiDung>, IActiveRecord
	{
		...
		private TBDCMS.DataAccess.BaiVietCollection colBaiVietRecords;
		public TBDCMS.DataAccess.BaiVietCollection BaiVietRecords()
		{
			if(colBaiVietRecords == null)
			{
				colBaiVietRecords = new TBDCMS.DataAccess.BaiVietCollection().Where(BaiViet.Columns.TacGiaId, Id).Load();
		...
		public TBDCMS.DataAccess.NguoiDungVaiTroChitietCollection NguoiDungVaiTroChitietRecords()
		{
			...
			{
				colNguoiDungVaiTroChitietRecords = new TBDCMS.DataAccess.NguoiDungVaiTroChitietCollection().Where(NguoiDungVaiTroChitiet.Columns.NguoiDungId, Id).Load();
        ...
        public void SetPKValues()
        {
                if (colBaiVietRecords != null)
                {
                    foreach (TBDCMS.DataAccess.BaiViet item in colBaiVietRecords)
                    {
