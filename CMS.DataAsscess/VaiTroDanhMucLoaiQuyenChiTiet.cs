...
namespace TBDCMS.DataAccess
{
	...
	public partial class VaiTroDanhMucLoaiQuyenChiTiet : ActiveRecord<VaiTroDanhMucLoaiQuyenChiTiet>, IActiveRecord
	{
		...
		/// 
		/// </summary>
		public TBDCMS.DataAccess.LoaiQuyen LoaiQuyen
		{
			get { return TBDCMS.DataAccess.LoaiQuyen.FetchByID(this.LoaiQuyenId); }
		...
		/// 
		/// </summary>
		public TBDCMS.DataAccess.MenuAdmin MenuAdmin
		{
			get { return TBDCMS.DataAccess.MenuAdmin.FetchByID(this.MenuId); }
		...
		/// 
		/// </summary>
		public TBDCMS.DataAccess.VaiTro VaiTro
		{
			get { return TBDCMS.DataAccess.VaiTro.FetchByID(this.VaiTroId); }
