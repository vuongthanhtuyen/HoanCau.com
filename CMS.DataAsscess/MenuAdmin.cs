...
namespace TBDCMS.DataAccess
{
	...
	public partial class MenuAdmin : ActiveRecord<MenuAdmin>, IActiveRecord
	{
		...
		private TBDCMS.DataAccess.MenuAdminCollection colChildMenuAdminRecords;
		public TBDCMS.DataAccess.MenuAdminCollection ChildMenuAdminRecords()
		{
			if(colChildMenuAdminRecords == null)
			{
				colChildMenuAdminRecords = new TBDCMS.DataAccess.MenuAdminCollection().Where(MenuAdmin.Columns.MenuChaId, Id).Load();
		...
		public TBDCMS.DataAccess.VaiTroDanhMucLoaiQuyenChiTietCollection VaiTroDanhMucLoaiQuyenChiTietRecords()
		{
			...
			{
				colVaiTroDanhMucLoaiQuyenChiTietRecords = new TBDCMS.DataAccess.VaiTroDanhMucLoaiQuyenChiTietCollection().Where(VaiTroDanhMucLoaiQuyenChiTiet.Columns.MenuId, Id).Load();
		...
		/// 
		/// </summary>
		public TBDCMS.DataAccess.MenuAdmin ParentMenuAdmin
		{
			get { return TBDCMS.DataAccess.MenuAdmin.FetchByID(this.MenuChaId); }
        ...
        public void SetPKValues()
        {
                if (colChildMenuAdminRecords != null)
                {
                    foreach (TBDCMS.DataAccess.MenuAdmin item in colChildMenuAdminRecords)
                    {
