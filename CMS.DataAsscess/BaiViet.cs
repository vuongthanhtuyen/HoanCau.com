...
namespace TBDCMS.DataAccess
{
	...
	public partial class BaiViet : ActiveRecord<BaiViet>, IActiveRecord
	{
		...
		private TBDCMS.DataAccess.NhomBaiVietCollection colNhomBaiVietRecords;
		public TBDCMS.DataAccess.NhomBaiVietCollection NhomBaiVietRecords()
		{
			if(colNhomBaiVietRecords == null)
			{
				colNhomBaiVietRecords = new TBDCMS.DataAccess.NhomBaiVietCollection().Where(NhomBaiViet.Columns.BaiVietId, Id).Load();
		...
		private TBDCMS.DataAccess.NhomHinhAnhCollection colNhomHinhAnhRecords;
		public TBDCMS.DataAccess.NhomHinhAnhCollection NhomHinhAnhRecords()
		{
			if(colNhomHinhAnhRecords == null)
			{
				colNhomHinhAnhRecords = new TBDCMS.DataAccess.NhomHinhAnhCollection().Where(NhomHinhAnh.Columns.BaiVietId, Id).Load();
		...
		/// 
		/// </summary>
		public TBDCMS.DataAccess.NguoiDung NguoiDung
		{
			get { return TBDCMS.DataAccess.NguoiDung.FetchByID(this.TacGiaId); }
        ...
        public void SetPKValues()
        {
                if (colNhomBaiVietRecords != null)
                {
                    foreach (TBDCMS.DataAccess.NhomBaiViet item in colNhomBaiVietRecords)
                    {
                ...
                if (colNhomHinhAnhRecords != null)
                {
                    foreach (TBDCMS.DataAccess.NhomHinhAnh item in colNhomHinhAnhRecords)
                    {
                        if (item.BaiVietId != Id)
                        {
                            item.BaiVietId = Id;
